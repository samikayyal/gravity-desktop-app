...
import 'my_dialog.dart'; // Import the new dialog widget
        ...
        return MyDialog(
          child: Column(
            ...
            children: [
              ...
              Text("Session Details", style: AppTextStyles.sectionHeaderStyle),
              const SizedBox(height: 8),
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: _isCheckoutEnabled
                        ? () {
                            int amountReceived =
                                int.tryParse(_amountReceivedController.text) ??
                                    0;
