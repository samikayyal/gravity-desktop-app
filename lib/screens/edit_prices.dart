...
class EditPricesScreen extends ConsumerWidget {
  EditPricesScreen({super.key});
  final _formKey = GlobalKey<FormState>();
  TextEditingController hourPriceController = TextEditingController();
  TextEditingController halfHourPriceController = TextEditingController();
  TextEditingController additionalHourPriceController = TextEditingController();
  TextEditingController additionalHalfHourPriceController =
      TextEditingController();

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final previousPricesAsync = ref.watch(pricesProvider);
    return previousPricesAsync.when(data: (previousPrices) {
      // Set controller values from previousPrices
